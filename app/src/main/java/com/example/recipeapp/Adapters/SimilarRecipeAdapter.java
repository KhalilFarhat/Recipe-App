...
import com.example.recipeapp.Adapters.SimilarRecipeViewHolder;
...
class SimilarRecipeViewHolder extends RecyclerView.ViewHolder{
    ...
    TextView similar_recipe_title , textView_similar_serving;
    ...
    public SimilarRecipeViewHolder(@NonNull View itemView) {
        ...
        similar_recipe_title = itemView.findViewById(R.id.textView_similar_title);
